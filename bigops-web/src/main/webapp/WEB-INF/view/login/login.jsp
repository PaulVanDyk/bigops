...
<%--<link href="http://fonts.useso.com/css?family=Open+Sans:400,300,600,700&subset=all" rel="stylesheet" type="text/css" />--%>
    ...
    <link href="<%=contextPath%>/assets/pages/css/login-4.min.css" rel="stylesheet" type="text/css" />
...
<body class="login">
    ...
    <div class="logo">
        <a href="<%=contextPath%>/">
            <img src="<%=contextPath%>/assets/pages/img/logo-big.png" alt="" /> </a>
    </div>
    <!-- END LOGO -->
    <!-- BEGIN LOGIN -->
    <div class="content">
        ...
        <form class="login-form">
            ...
            <div class="form-actions">
                ...
                <button id="submit" type="submit" class="btn green pull-right"> Login </button>
            </div>
    ...
    <%--<script src="<%=contextPath%>/assets/pages/scripts/form-validation.min.js" type="text/javascript"></script>--%>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var error = $('.alert-danger', loginForm);
        var success = $('.alert-success', loginForm);
        loginForm.validate({
            errorElement: 'span',
            ...
            messages:{
                ...
                error.find("span").text("Enter any username and password.");
                error.show();
...
//                        success.find("span").text("登陆成功，系统跳转中...");
                    ...
                    error.find("span").text("系统异常，请联系管理员进行处理。");
                    error.show();
                });
            }
        })
