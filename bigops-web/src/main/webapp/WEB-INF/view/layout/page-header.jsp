...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="index.html">
                <img src="<%=contextPath%>/assets/layouts/layout4/img/logo-biyao.png" alt="logo" class="logo-default"/>
            </a>
        ...
        <div class="page-top">
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended dropdown-notification dropdown-dark hide"
                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;"
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="<%=contextPath%>/assets/layouts/layout4/img/avatar2.jpg"
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="<%=contextPath%>/assets/layouts/layout4/img/avatar3.jpg"
                                                             class="img-circle" alt=""> </span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="<%=contextPath%>/assets/layouts/layout4/img/avatar1.jpg"
                                                             class="img-circle" alt=""> </span>
                                            <span class="subject">
                    ...
                    <li class="dropdown dropdown-user dropdown-dark">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            <span id="username"
                                  class="username username-hide-on-mobile"> <%=session.getAttribute("user")%> </span>
                            <!-- DOC: Do not remove below empty space(&nbsp;) as its purposely used -->
                            <img alt="" class="img-circle"
                                 src="<%=contextPath%>/assets/layouts/layout4/img/avatar9.jpg"/> </a>
